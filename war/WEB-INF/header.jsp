		...
		<nav>
			<div id="menu_container" align="left">
				<ul class="sf-menu" id="nav">
					...
					<li><a href="contact"><font face="Antiochus">צור קשר</font></a></li>
					<li><a href="upload"><font face="Antiochus">העלאת מודעה</font></a></li>
					<li><a href="profile"><font face="Antiochus">פרופיל</font></a></li>
					<li><a href="index"><font face="Antiochus">עמוד הבית</font></a></li>
